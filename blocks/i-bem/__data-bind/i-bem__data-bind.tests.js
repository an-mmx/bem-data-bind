describe('i-bem__data-bind', function () {
    ...
    describe('synchronize primitive values', function () {
        ...
        it('do not call setter of source block', function () {
            ...
            expect(block1._val).to.equal(block2._val);
            expect(BEM.dataBindVal('param-3')).to.equal(block2._val);
            expect(block1setter).to.equal(false);
            expect(block2setter).to.equal(false);
            block1.val(randomValue());
            expect(block1._val).to.equal(block2._val);
            expect(BEM.dataBindVal('param-3')).to.equal(block1._val);
            expect(block1setter).to.equal(false);
            expect(block2setter).to.equal(true);
